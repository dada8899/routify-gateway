...
本文档提供使用宝塔面板 Docker 功能部署 Routify 的图文教程。
...
1. 在宝塔面板中创建网站目录，如 `/www/wwwroot/routify`
...
services:
  routify:
    image: calciumion/routify:latest
    container_name: routify
    restart: always
    ports:
      - "3000:3000"
    volumes:
...
- [GitHub 仓库](https://github.com/Routify/routify)
